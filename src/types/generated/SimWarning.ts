 ...
 */
allowed: number, } } | { "MatchUnallocated": { account: string, } } | { "AnnualAdditionsClamped": { account: string, period: number, requested: number, allowed: number, } } | "SurplusUnallocated" | "SweepBoundaryUnresolved" | { "RequiredDistributionUnallocated": { period: number, } } | { "UnknownPersonRef": { stream: string, } } | { "ContributionBoundaryUnresolved": { account: string, } };
